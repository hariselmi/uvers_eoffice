            ...
            @foreach ($semua_jenis_surat as $index=>$value)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="#editJenisSuratModal" data-replace-empty="#editJenisSurat" data-ajax-url="/jenis-surat/{{$value->id}}/edit" data-toggle="modal">
                        <button class="btn btn-small btn-warning pull-left" style="margin: 10px;"><i class="fa fa-edit"></i> Edit</button>
                        </a>



                        <a href="#" class="delete-form" onclick="return confirm('Apakah anda yakin?')"><form method="POST" action="/jenis-surat/{{$value->id}}" accept-charset="UTF-8" class="form-inline">
