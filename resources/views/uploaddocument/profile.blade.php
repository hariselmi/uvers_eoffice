<div class="modal-content" id="showDocument">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Nama Auditor </b> <a class="pull-right">{{ $uploaddocument->auditor_name }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Nama Auditee </b> <a class="pull-right">{{ $uploaddocument->auditee_name }}</a>
                            </li>
                            <li class="list-group-item hidden-print">
                                <b>Unit</b> <a class="pull-right">{{                              Get_field::get_data($uploaddocument->division_id, 'divisions', 'title') }}</a>
                            </li>
                            <li class="list-group-item hidden-print">
                                <b>Periode</b> <a class="pull-right">{{ Get_field::get_data($uploaddocument->period_id,'periods','title') }} {{ Get_field::get_data($uploaddocument->period_id,'periods','semester') }}</a>
                            </li>
                            <li class="list-group-item hidden-print">
                                <b>Tanggal Audit</b> <a class="pull-right">{{ Get_field::format_indo($uploaddocument->schedule_date) }}</a>
                            </li>
                             <li class="list-group-item hidden-print">
                                <b>Jam Audit</b> <a class="pull-right">{!!Get_field::get_data($uploaddocument->clock_start_id, 'clock', 'nama')!!} - {!!Get_field::get_data($uploaddocument->clock_finish_id, 'clock', 'nama')!!}</a>
                            </li>
                        </ul>
