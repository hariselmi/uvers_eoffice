            ...
            <td class="hidden-print">
                <div class="btn-group action-btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      ...
                      @endif
                      {{-- <li><a href="{{url('receivings/'. $value->id.'/edit')}}" onclick="return confirm('are you sure?')"><i class="fa fa-trash-o"></i> {{__('Tutup')}}</a></li> --}}
                    </ul>
                      ...
                      <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-success" data-dismiss="modal">{{__('Tutup')}}</button>
                            </div>
                          </div>
                      </div>
                    </div>
