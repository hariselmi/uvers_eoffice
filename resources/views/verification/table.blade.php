                    ...
                    <td>{{ $value->title }} {{ $value->semester }}</td>
                        <td class="item_btn_group">
                                @php
                                    ...
                                    //     ['data-replace' => '#editVerification', 'url' => '#editVerificationModal', 'ajax-url' => url('verification/' . $value->id . '/edit'), 'name' => ' Sunting', 'icon' => 'pencil'], 
                                    //     ['url' => 'verification/' . $value->id . '/print', 'name' => ' Cetak', 'target' => '_blank', 'icon' => 'print']];\


                                $actions = [];
                                        $edit = ['data-replace' => '#editVerification', 'url' => '#editVerificationModal', 'ajax-url' => url('verification/' . $value->id . '/edit'), 'name' => ' Sunting', 'icon' => 'pencil'];
