        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-3 pr-0 bottom_border text-left">
                <div class="sale-logo">
                    ...
                    @else
                    <img src="{{asset('images/logo_uvers.png')}}" alt="logo">
                    @endif 
                </div>
            </div>
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
            <div class="row invoice-footer">
                ...
                {{--<div class="col-xs-4">{{__('Discount')}}: </div>
                 <div class="col-xs-8"> 
                    <span class="text-left"> {{currencySymbol()}}</span><span class="pull-right"> {{ $receivings->discount }}</span>
                </div> --}}
                <div class="col-xs-4">{{__('Payment')}}: </div>
                <div class="col-xs-8"> 
                    <span class="text-left"> {{currencySymbol()}}</span><span class="pull-right"> {{ $receivings->payment }}</span>
                </div>
                {{-- <div class="col-xs-4">{{__('Tax')}}: </div><div class="col-xs-8"> <span class="text-left">{{currencySymbol()}}</span><span class="pull-right"> {{ $receivings->tax }}</span></div> --}}
