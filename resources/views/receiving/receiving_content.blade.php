                ...
                <div class="col-sm-3 pr-0">
                    ...
                    <table class="table table-hover">
                        <tr ng-repeat="item in items  | filter: searchKeyword | limitTo:10">
                            <td width="20%"><img src=@{{item.savatar}} alt="" width="60"></td>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            {{-- <div class="form-group">
                                <label for="employee" class="col-sm-4 control-label">{{trans('receiving.employee')}}</label>
                                <div class="col-sm-8">
                    ...
                    <table class="table table-bordered">
                        ...
                        <td class="hidden-xs">@{{newreceivingtemp.item_id}}</td><td>@{{newreceivingtemp.item.item_name}}</td><td>{{currencySymbol()}}@{{newreceivingtemp.item.cost_price }}</td><td><input type="text" style="text-align:center" autocomplete="off" name="quantity" ng-change="updateReceivingTemp(newreceivingtemp)" ng-model="newreceivingtemp.quantity" size="2"></td><td>{{currencySymbol()}}@{{newreceivingtemp.item.cost_price * newreceivingtemp.quantity }}</td><td><button class="btn btn-danger btn-xs" type="button" ng-click="removeReceivingTemp(newreceivingtemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                        </tr>
                        <tr>
