<div class="modal-content" id="lihatRepositoriInternal">
    <section class="content-header">
        <h1><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            {{ __('Repositori Surat keluar Internal') }}</h1>
    </section>
    <!-- Main content -->
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">Surat Internal</td>
                        ...
                        <!-- Laporan -->
                        <?php 
                        foreach ($surat_keluar_laporan as $key => $value) { 
                        $no++;
                        ?>
                            <tr>
                                <td width="50" class="hidden-xs text-center"><?=$no?></td>
