...
class CheckList extends Model
{
    ...
    public function getAll($option=null, $search=null) {
        ...
        if ($userRole == 'admin') {
            # code...
            $results = $this->select('check_lists.id', 'check_lists.schedule_id', 'schedules.division_id', 'schedules.schedule_date', 'schedules.clock_start_id', 'schedules.clock_finish_id', 'schedules.status', 'auditor.name as auditor_name', 'auditee.name as auditee_name','schedules.period_id')
            ->leftJoin('schedules', 'check_lists.schedule_id', 'schedules.id')
