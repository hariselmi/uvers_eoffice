...
class ViewComposer extends Provider
{
    ...
    public function boot()
    {
        // invoice
        View::composer(
            ['sale.sale_content', 'receiving.receiving_content', 'expense.form', 'customer.partials.sale_table', 'supplier.partials.receiving_table', 'customer.profile', 'supplier.profile'], 'App\Http\ViewComposers\Invoice'
        );
