...
class FlexiblePosSettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // else {
        //     $input['logo_path'] = 'public/images/company/logo_uvers.png';
        // }
        if (!empty($input['fevicon_path'])) {
            $input['fevicon_path'] = $this->uploadImage($request->fevicon_path, "images/company");
        } 
        // else {
        //     $input['fevicon_path'] = 'public/images/company/fevicon.png';
        // }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($input['logo_path'])) {
            $input['logo_path'] = $this->uploadImage($request->logo_path, "images/company");
            if (file_exists($flexiblepossetting->logo_path) && $flexiblepossetting->logo_path != 'images/logo_uvers.png') {
                unlink($flexiblepossetting->logo_path);
            }
        }
        if (!empty($input['fevicon_path'])) {
            $input['fevicon_path'] = $this->uploadImage($request->fevicon_path, "images/company");
            if (file_exists($flexiblepossetting->fevicon_path) && $flexiblepossetting->fevicon_path != 'images/fuvers.png') {
