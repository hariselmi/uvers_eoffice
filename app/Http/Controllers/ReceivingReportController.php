...
class ReceivingReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //->with('saleReport', $salesReport)->with('formated_report', $formated_report)->with('units', $months)->with('input', $request->all())->with('months', $months)->with('formated_expense', $formated_expense)->with('expense_cat', $expense_cat);
    }
    /**
