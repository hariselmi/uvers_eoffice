(function(){
    ...
    app.controller("SearchItemCtrl", [ '$scope', '$http', function($scope, $http) {
        ...
        $scope.addCustomItem = function(customitem) {
            ...
            $http.post(site_url+'/item/customcreate', { item_name: customitem.item_name, cost_price: customitem.cost_price, selling_price: customitem.selling_price, quantity: customitem.quantity, type: 'sale' }).
            success(function(data, status, headers, config) {
                $scope.customitem = { };
